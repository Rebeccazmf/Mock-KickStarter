...
export class PurchaselistComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //this.purchaselistService.getUser(this.username);
    //console.log(this.purchaselistService.getUserId(this.username));
  }
 ...
 /* onSubmit = (startupForm: NgForm) => {
   ...
   // startupForm.controls['userId'].setValue(this.purchaselistService.getUser());
    this.purchaselistService.addIdea(startupForm.value)
      .subscribe((res) => {
        console.log(res);
        this.refreshIdea();
        this.toggleAdd();
  ...
  onDelete = () => {
    ...
    this.purchaselistService.deleteIdea(this.idea)
      .subscribe((res) => {
        console.log(res);
        this.modal.close();
        this.refreshIdea();
  ...
  onEdit = () => {
    this.purchaselistService.editIdea(this.idea)
    .catch(
      (error)=>{
        console.log('testing');
  ...
  refreshPurchase = () => {
    this.purchaselistService.getPurchases()
      .subscribe(
      (purchases) => {
